...
---@field public edgeColor rgbaColor the color of the panel edge
---@field public fillColor rgbaColor the color of the panel fill
...
---@overload fun(args:UIPanelArgs):UIPanel
local UIPanel=UI.Base:extend()

---@class UIPanelArgs:UIBaseArgs
---@field edgeWidth? number
---@field edgeColor? rgbaColor
---@field fillColor? rgbaColor
---@field shader? love.Shader
---@param args UIPanelArgs
