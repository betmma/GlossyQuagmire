...
function DanmakuFuncs.sentry(pos)
    local sentry=Bullet{kinematicState={pos=pos and copyTable(pos) or G.runInfo.geometry:init().pos,speed=0,dir=0},sprite=BulletSprites.round.red,lifeFrame=99999,invincible=true,safe=true,spriteTransparency=0}
