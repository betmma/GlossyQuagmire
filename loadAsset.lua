...
local hitRadius={laser=3,scale=2.4,rim=2.4,round=4,rice=2.4,kunai=2.4,crystal=2.4,bill=2.8,bullet=2.4,blackrice=2.4,star=4,darkdot=2.4,dot=2.4,bigStar=7,bigRound=8.5,butterfly=7,knife=5,ellipse=6,fog=8.5,heart=7,giant=14,lightRound=13.5,hollow=2.4,flame=6,orb=6,moon=60,nuke=96,explosion=38,snake=2.4,shockwave=64,stick=1.2,stickDark=1.2}
...
local bossImagePoses={{name='placeholder',num=4},{name='tooshi',num=4},{name='marisa',num=2},{name='kotoba',num=4},{name='reimu',num=4},{name='shouji',num=4},{name='cora',num=2,x0=2,y0=2}}
