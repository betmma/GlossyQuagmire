...
return {
    base=base,
    init=function(self)
        local transBase=UI.Base{parent=base,extraUpdates={function(self)
            self.transparency=(1-math.exp(-base.frame/10))
            if base.resumeFrame then
                self.transparency=self.transparency*(1-(base.frame-base.resumeFrame)/resumeDuration)
            end
        end}}
    ...
    update=function(self,dt)
        ...
        if base.resumeFrame and base.frame>base.resumeFrame+30 then
