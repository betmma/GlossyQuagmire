...
local bgm=SmoothAudioSystem{folder='bgm',fileSuffix='.mp3',fileNames={'title','level1','level1b','level1c','level2','level2b','level3','level3b','level4','level4b','level5'},volumeCoeff=1,looping=true,unique=true,defaultAudio='level2b',loadType='stream',defaultRestart=false}
